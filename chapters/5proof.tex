...
\begin{thm}\label{thm:two_sided_cobar_D}
	...
	\begin{proof}
		Denote $\Cobar(\cdots)$ by $\Cobar$. Singular chains are free abelian groups, hence flat over $\Z$. Moreover, over $\Z$, submodules of free modules are free. Lastly, the associated gradeds of the singular chains are torsion-free \footnote{Need to prove this}, hence free and flat over $\Z$. 
