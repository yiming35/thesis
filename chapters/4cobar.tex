...
\begin{thm}\label{thm:stallings_generalization}
    ...
    \[\phi(d_H(1_a\tensor \tau\tensor 1_b)) = \phi(e_0-e_1+e_2) = [1-\tilde{e}_0-(1-\tilde{e}_1) + 1-\tilde{e}_2] = 1-\tilde{e}_0 + \tilde{e}_1 - \tilde{e}_2.\]
    On the other hand, the Alexander--Whitney diagonal sends $\tau \in C_2(X)$ to 
    \[e_0 \tensor \tau + [e_0e_1] \tensor [e_1e_2] + \tau \tensor [e_2]\]
    \end{proof}
\end{thm}
