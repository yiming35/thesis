...
\begin{thm}\label{thm:stallings_generalization}
    ...
    So $\tilde{\phi}$ descends to a map $\phi: H_0\tot \to \Z\pi_1(X,a)[s_b]$. Because the row-wise filtration on $\tot\Cobar$ corresponds exactly to tensor length, we have that the restriction of $\phi$ is an isomorphism onto $\mathcal{I}^p$, so that 
