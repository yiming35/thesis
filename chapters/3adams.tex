...
\begin{lem}
    ...
    \end{proof}
\end{lem}
Because we will use this notion many more times times in this thesis, we make the following \emph{ad hoc} definition: 
\begin{defn}
...
\end{defn}
Then Proposition \ref{prop:twoside_reduction} says that a quasi-isomorphism of bicomplexes induces a quasi-isomorphism of totalizations. 
...
There is a sense in which Adams' theorem allows one to use homology to approximate the fundamental group. ..
