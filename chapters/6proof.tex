...
\begin{thm}\label{thm:two_sided_cobar_D}
	...
	\begin{proof}
		Denote $\Cobar(\cdots)$ by $\Cobar$. By flatness, Lemma \ref{lem:normalized_inclusion_is_graded_quism}, and Lemma \ref{lem:graded_quism} it suffices to exhibit a quasi-isomorphism from 
...
\begin{proof}[Proof of Theorem \ref{thm:looijenga}]
	...
	\begin{equation}\label{eqn:N_and_fundamental_gp}
		 \Z\pi_X(a,b)/\Z\pi_X(a,b)\mathcal{I}^{n+1} \to H_0\tot(\mathscr{N}^{\leq n}) 
	\end{equation}
